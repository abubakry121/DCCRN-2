...
def main():
    ...
    #
    train_dataset = PrimewordsMD2018(dataset_path="/content/drive/MyDrive/STARGAN/archive (7)/noisy_trainset_wav", noise_path="/content/drive/MyDrive/STARGAN/archive (7)/noisy_trainset_wav", use_rate=0.1)
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True)
    validate_dataset = PrimewordsMD2018(dataset_path="/content/drive/MyDrive/STARGAN/archive (7)/clean_trainset_wav", noise_path="/content/drive/MyDrive/STARGAN/archive (7)/clean_trainset_wav", use_rate=0.2)
